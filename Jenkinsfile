pipeline {
  ...
  environment {
    ...
    SONAR_URL   = 'http://35.180.178.205:9000'
    NEXUS_URL   = 'http://35.180.178.205:8081/repository/maven-snapshots/'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://35.180.178.205:8081/repository/maven-snapshots/'
    }
  }
}
  }
